# parse = '1\t11\tnsubj\n2\t3\tcase\n3\t1\tnmod:of\n4\t5\tcompound\n5\t1\tnummod\n6\t8\tpunct\n7\t8\tnummod\n8\t11\tnsubj\n9\t11\tcop\n10\t11\tcompound\n11\t0\troot\n12\t14\tcase\n13\t14\tcompound\n14\t11\tnmod:to\n15\t18\tcase\n16\t18\tdet\n17\t18\tcompound\n18\t14\tnmod:of\n19\t11\tcc\n20\t21\tadvmod\n21\t11\tconj:and\n22\t23\tcase\n23\t21\tnmod:of\n24\t27\tcase\n25\t27\tnmod:poss\n26\t27\tcompound\n27\t21\tnmod:during\n28\t11\tpunct'
#
# words_str = '{"Alexandra","of","Denmark","(","1844","-","1925",")","was","Queen","Consort","to","Edward","VII","of","the","United","Kingdom","and","thus","Empress","of","India","during","her","husband\'s","reign","."}'
#
# subject_start, subject_end = 0, 3
# object_start, object_end = 12, 14
# relation = 'per:spouse'
...
def get_path_from_parse(parse, subject_start, subject_end, object_start, object_end):
    ...
    return get_path(get_head(node_map[subject_end-1], subject_start, subject_end), get_head(node_map[object_end-1], object_start, object_end), g)
